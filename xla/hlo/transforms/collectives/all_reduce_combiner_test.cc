...
TEST_F(AllReduceCombinerTest, PreservesMetadata) {
  absl::string_view hlo_text = R"(
    ...
    ENTRY entry {
      ...
      %all-reduce.0 = f32[32] all-reduce(%param.0), replica_groups={}, to_apply=%add, metadata={op_type="test_type" op_name="test_name"}
      %all-reduce.1 = f32[32] all-reduce(%param.1), replica_groups={}, to_apply=%add, metadata={op_type="test_type" op_name="test_name"}
